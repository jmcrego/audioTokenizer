...
if __name__ == "__main__":
    ...
    parser.add_argument("--eval_every", type=int, default=500, help="Run evaluation after this many optimization steps")
    parser.add_argument("--log_every", type=int, default=50, help="Logging after this many optimization steps")
